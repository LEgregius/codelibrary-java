...
import io.swagger.client.model.GETSubscriptionType;
...
public class GETSubscriptionWrapper   {
  ...
  private List<GETSubscriptionType> subscriptions = new ArrayList<GETSubscriptionType>();
  ...
  public GETSubscriptionWrapper addSubscriptionsItem(GETSubscriptionType subscriptionsItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Array of subscriptions. ")
  public List<GETSubscriptionType> getSubscriptions() {
    return subscriptions;
  }

  public void setSubscriptions(List<GETSubscriptionType> subscriptions) {
    this.subscriptions = subscriptions;
  }

  public GETSubscriptionWrapper success(Boolean success) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class GETSubscriptionWrapper {\n");
