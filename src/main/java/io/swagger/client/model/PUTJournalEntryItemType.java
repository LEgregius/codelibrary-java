...
public class PUTJournalEntryItemType   {
  ...
  private String accountingCodeName = null;

  @SerializedName("accountingCodeType")
  private String accountingCodeType = null;
  ...
  public PUTJournalEntryItemType accountingCodeName(String accountingCodeName) {
  ...
  **/
  ...
  public PUTJournalEntryItemType accountingCodeType(String accountingCodeType) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Accounting code type. The accounting code types are:   * `AccountsReceivable`   *  `Cash`   *  `OtherAssets`   *  `CustomerCashOnAccount `   * `DeferredRevenue`   * `SalesTaxPayable`   * `OtherLiabilities`   * `SalesRevenue`   * `SalesDiscounts`   * `OtherRevenue`    * `OtherEquity`   * `BadDebt`     * `OtherExpenses`        ")
  ...
  public PUTJournalEntryItemType customFieldC(String customFieldC) {
  ...
  **/
  ...
  public PUTJournalEntryItemType type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = "Type of journal entry item. An enum with the value `Credit` or `Debit`. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PUTJournalEntryItemType pUTJournalEntryItemType = (PUTJournalEntryItemType) o;
    return Objects.equals(this.accountingCodeName, pUTJournalEntryItemType.accountingCodeName) &&
        Objects.equals(this.accountingCodeType, pUTJournalEntryItemType.accountingCodeType) &&
        Objects.equals(this.customFieldC, pUTJournalEntryItemType.customFieldC) &&
        Objects.equals(this.type, pUTJournalEntryItemType.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountingCodeName, accountingCodeType, customFieldC, type);
  }
