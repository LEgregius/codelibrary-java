...
public class ProxyActionsubscribeResponse   {
  ...
  public ProxyActionsubscribeResponse addResultItem(SubscribeResult resultItem) {
  ...
  **/
  ...
  public List<SubscribeResult> getResult() {
    return result;
  }

  public void setResult(List<SubscribeResult> result) {
    this.result = result;
  }
