...
public class POSTAccountResponseType   {
  ...
  public POSTAccountResponseType accountId(String accountId) {
   ...
   * @return accountId
  **/
  @ApiModelProperty(example = "null", value = "Auto-generated account ID. ")
  ...
  public POSTAccountResponseType accountNumber(String accountNumber) {
  ...
  **/
  ...
  public POSTAccountResponseType contractedMrr(String contractedMrr) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Contracted [monthly recurring revenue](https://knowledgecenter.zuora.com/BC_Subscription_Management/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/A_Monthly_Recurring_Revenue) of the subscription. ")
  ...
  public POSTAccountResponseType invoiceId(String invoiceId) {
   ...
   * @return invoiceId
  **/
  @ApiModelProperty(example = "null", value = "ID of the invoice generated at account creation, if applicable. ")
  ...
  public POSTAccountResponseType paidAmount(String paidAmount) {
   ...
   * @return paidAmount
  **/
  @ApiModelProperty(example = "null", value = "Amount collected on the invoice generated at account creation, if applicable. ")
  ...
  public POSTAccountResponseType paymentId(String paymentId) {
   ...
   * @return paymentId
  **/
  @ApiModelProperty(example = "null", value = "ID of the payment collected on the invoice generated at account creation, if applicable. ")
  ...
  public POSTAccountResponseType paymentMethodId(String paymentMethodId) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "ID of the payment method that was set up at account creation, which automatically becomes the default payment method for this account. ")
  ...
  public POSTAccountResponseType subscriptionId(String subscriptionId) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "ID of the subscription that was set up at account creation, if applicable. ")
  ...
  public POSTAccountResponseType subscriptionNumber(String subscriptionNumber) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Number of the subscription that was set up at account creation, if applicable. ")
  ...
  public POSTAccountResponseType success(Boolean success) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "[Total contracted value](https://knowledgecenter.zuora.com/P_Glossary) of the subscription. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTAccountResponseType pOSTAccountResponseType = (POSTAccountResponseType) o;
    return Objects.equals(this.accountId, pOSTAccountResponseType.accountId) &&
        Objects.equals(this.accountNumber, pOSTAccountResponseType.accountNumber) &&
        Objects.equals(this.contractedMrr, pOSTAccountResponseType.contractedMrr) &&
        Objects.equals(this.invoiceId, pOSTAccountResponseType.invoiceId) &&
        Objects.equals(this.paidAmount, pOSTAccountResponseType.paidAmount) &&
        Objects.equals(this.paymentId, pOSTAccountResponseType.paymentId) &&
        Objects.equals(this.paymentMethodId, pOSTAccountResponseType.paymentMethodId) &&
