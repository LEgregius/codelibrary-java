...
public class POSTDecryptResponseType   {
  ...
  private String decryptedSignature = null;
  ...
  **/
  @ApiModelProperty(example = "null", value = "The string of a list of the following items: Payment Pages 2.0 URL, tenant ID, timestamp,the Payment Page ID  The items are separated by '#', e.g., \"/apps/publichostedpagelite.do#12271#rvBp1AxBJwk6FrT7aqFuABIINiRbwJCc #1418848373103#2c92c0f948f899\" ")
  ...
  public POSTDecryptResponseType publicKey(String publicKey) {
   ...
   * @return publicKey
  **/
  @ApiModelProperty(example = "null", value = "The public key passed in as a request parameter. ")
  ...
  public POSTDecryptResponseType signature(String signature) {
   ...
   * @return signature
  **/
  @ApiModelProperty(example = "null", value = "The signature passed in as a request parameter. ")
  ...
  public POSTDecryptResponseType success(Boolean success) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    POSTDecryptResponseType pOSTDecryptResponseType = (POSTDecryptResponseType) o;
  ...
  public String toString() {
    ...
    sb.append("    decryptedSignature: ").append(toIndentedString(decryptedSignature)).append("\n");
